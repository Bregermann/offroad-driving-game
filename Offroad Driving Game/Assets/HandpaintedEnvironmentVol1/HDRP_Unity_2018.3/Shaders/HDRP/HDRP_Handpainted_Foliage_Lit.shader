Shader "HandpaintedVol1/HDRP/Handpainted_Foliage_Lit"
{
    Properties
    {
            ...
            //-------------------------------------------------------------------------------------
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        float _OneMinus_C35D174B_Out;
                        Unity_OneMinus_float(_SampleTexture2D_F31074AB_R, _OneMinus_C35D174B_Out);
                        ...
                        surface.Thickness = _OneMinus_C35D174B_Out;
                        surface.DiffusionProfile = 2;
                        surface.CoatMask = 0;
    ...
    float unity_gradientNoise(float2 p)
    {
        ...
        return lerp(lerp(d00, d01, fp.y), lerp(d10, d11, fp.y), fp.x);
                ...
                // Vertex Graph Evaluation
                    ...
                    {
                        VertexDescription description = (VertexDescription)0;
                        float2 _Property_E1548300_Out = Vector2_3FE1035C;
                        float2 _Multiply_6501996F_Out;
                        Unity_Multiply_float((_Time.y.xx), _Property_E1548300_Out, _Multiply_6501996F_Out);
                    
                        float2 _TilingAndOffset_5685C2FB_Out;
                        Unity_TilingAndOffset_float((IN.ObjectSpacePosition.xy), float2 (1,1), _Multiply_6501996F_Out, _TilingAndOffset_5685C2FB_Out);
                        float _Vector1_360881B9_Out = 0.75;
                        float _GradientNoise_2F6C6785_Out;
                        Unity_GradientNoise_float(_TilingAndOffset_5685C2FB_Out, _Vector1_360881B9_Out, _GradientNoise_2F6C6785_Out);
                        ...
                        Unity_Add_float(_GradientNoise_2F6C6785_Out, _GradientNoise_1B938AB4_Out, _Add_372F5890_Out);
                        float _Multiply_C23E6F9C_Out;
                        Unity_Multiply_float(_GradientNoise_2F6C6785_Out, _Add_372F5890_Out, _Multiply_C23E6F9C_Out);
                    
                        float _Subtract_6DB9C88F_Out;
                        Unity_Subtract_float(_Multiply_C23E6F9C_Out, 0.5, _Subtract_6DB9C88F_Out);
                        ...
                        Unity_Subtract_float3((_Combine_A0BAC6E0_RGBA.xyz), _WorldSpaceCameraPos, _Subtract_E093ACDE_Out);
